    ...
    <div class="container">
        ...
        <div class="login-form-grids">
            ...
            <form:form action="/checkout" method="post" modelAttribute="order">
                <form:input path="receiver" placeholder="Recipient's name..."  required="true"></form:input>
                <form:input path="address" placeholder="Address..." required="true"></form:input>
                <form:input path="description"  placeholder="Recipient's Phone Number..." required="true" pattern="^((09|03|07|08|05)+([0-9]{8})\b)$" title="Số điện thoại của bạn phải bao gồm 10 số và bắt đầu bằng các đầu số, 09, 08, 07, 05, 03"></form:input>


                <h6>Expected Date to Receive Goods</h6>
